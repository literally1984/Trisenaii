  ...
  public void run() {
    try {
      ...
      if (inv.createNewFile()) {
        // System.out.println("Game files successfully created.");
        pubstatints.successornot = true;
        /*
         * try { Thread.sleep(2000); System.out.print("\033[H\033[2J"); } catch
         * (Exception e) { }
         */
      } else {
        // System.out.println("Error: Game files not successfully created.");
...
public class TrisenaiiClass extends Thread {
  public static void main(String[] args) throws Exception {
    ...
    if (pubstatints.successornot == true) {
      System.out.println("Game files created successfully." + new Throwable().getStackTrace()[0].getLineNumber());
      Thread.sleep(1000);
    } else {
      //System.out.println(
          //"Error: Game files not successfully created. Parts of the game might not work correctly. Please try restarting the program.");
      //Thread.sleep(86400000);
    }
    System.out.print("\033[H\033[2J");
    System.out.println(
        " __    __  __  __    ___   ___          __   _____  ___   _____        __   __    __  ___  __    __    ___     ___  ___  ");
    Thread.sleep(800);
    System.out.println(
        "/ / /\\ \\ \\/__\\/ /   / __\\ /___\\/\\/\\    /__\\ /__   \\/___\\ /__   \\/\\  /\\/__\\ / / /\\ \\ \\/___\\/__\\  / /   /   \\   /___\\/ __\\");
    Thread.sleep(800);
    System.out.println(
        "\\ \\/  \\/ /_\\ / /   / /   //  //    \\  /_\\     / /\\//  //   / /\\/ /_/ /_\\   \\ \\/  \\/ //  // \\// / /   / /\\ /  //  // _\\  ");
    Thread.sleep(800);
    System.out.println(
        " \\  /\\  //__/ /___/ /___/ \\_// /\\/\\ \\//__    / / / \\_//   / / / __  //__    \\  /\\  / \\_// _  \\/ /___/ /_//  / \\_// /    ");
    Thread.sleep(800);
    System.out.println(
        "  \\/  \\/\\__/\\____/\\____/\\___/\\/    \\/\\__/    \\/  \\___/    \\/  \\/ /_/\\__/     \\/  \\/\\___/\\/ \\_/\\____/___,'   \\___/\\/     ");
    Thread.sleep(4000);
    ...
    Thread.sleep(4500);
    System.out.println(
        "The note reads: ATTENTION, CITIZEN. You have been woken at this untimely hour to report immediately at the town hall for a town meeting. Make haste!");
    Thread.sleep(8000);
    ...
    Thread.sleep(3000);
    System.out.println(
        "Okay, let's just get this over with. We'll start off with the different types of text you'll see displayed.");
    Thread.sleep(6000);
    System.out.println(
        "When you see text like this sentence, it means I, the narrator, am either telling you something or am describing you.");
    Thread.sleep(4500);
    ...
    Thread.sleep(4000);
    System.out.println(
        "Now let's get started on decisions. Throughout the game, you'll be presented with a few choices about what to do in a situation. You will have to type the choice you choose. When you have options to talk to NPCs, to get out of the situation, type 'Walk' to walk away.");
    Thread.sleep(6000);
    System.out.println("Example:");
    Thread.sleep(4000);
    ...
    System.out.println(
        "Walk               Talk to man               Talk to other man               Talk to woman            Talk to other woman");
    String walk = "Walk";
    ...
    while (done == false) {
      ...
      if (tutorialexample.equals(walk)) { // walk
        ...
        System.out.println(
            "Other woman: <Tutorials sure are stupid, aren't they? They always treat you like you're five and it's your first videogame.>");
      } else { // wrong
        System.out.println("Error: User input not recognized. Try again?");
        System.out.println("                      Actions:");
        System.out.println(
    ...
    System.out.println(
        "First weapon type: Clubs. These only deal damage, and have no secondary attacks. The damage they do deal, however, is the most of any weapon type.");
    Thread.sleep(4000);
    System.out.println(
        "Second weapon type: Swords. Their primary attacks deal damage, and their secondary attacks block enemy attacks, which lowers the amount of damage an enemy deals to you.");
    Thread.sleep(4000);
    System.out.println(
        "Third weapon type: Magic weapons. Their primary attacks deal damage. Unlike the other weapon types, the secondary attacks for these change from weapon to weapon. For example, one magic weapon's secondary attack might be leeching an enemy's health, while another's would be, well, different from that.");
    Thread.sleep(5000);
    System.out.println(
        "Fourth and final weapon type: Electric weapons. Their primary attacks deal damage and chain damage to other enemies if there are more than one. Their secondary attacks increase attack damage.");
    Thread.sleep(5000);
    System.out.println(
        "This stupid tutorial's already gone on for long enough. Let's end it by pitting you against an Olbap, a pretty common enemy in the game. Which starter weapon do you choose to use to fight against it and use in the game until you find a better weapon? (You can always switch weapon types. For example, just because you picked the starter sword right now doesn't mean you can't use electric weapons later on.)");
    Thread.sleep(6000);
    System.out.println("                      Weapons:");
    System.out.println(
        "Heavy stick (club)     Velociraptor tooth (sword)     Street magician wand (magic weapon)    Damaged cable (electric weapon)");
    System.out.println(
        "Type in the name of the weapon you want. Don't type in the weapon type it belongs to. For example, just type 'Damaged cable'.");
    ...
    case "Velociraptor tooth":
      System.out.println(
          "Primary attack: Vicious slice[15-20 damage dealt]   Secondary attack: Block[1/4 less damage taken from enemy attacks, 1 turn]");
      break;
    case "Street magician wand":
      System.out.println(
          "Primary attack: Health goes poof[10-15 damage dealt]    Secondary attack: Leech[+8-10 health per attack, 2 turns]");
      break;
    case "Damaged cable":
      System.out.println(
          "Primary attack: Electric shock[10 damage dealt, 5-10 damage chained to other enemies]  Secondary attack: Static touch[+5 damage dealt, 2 turns]");
      break;
    }
    System.out.println(
        "To do a primary attack or secondary attack, type in its name. Don't type in the damage it deals or how long it lasts, just the name.");
    ...
    int olbapdcreasedmge = olbapattckdmgevt / 4;
    switch (tutrlbttl) {
    case "Heavy hit":
    ...
    case "Vicious slice":
      ...
      for (; olbaphealth > 0 && yourhealth > 0;) {
        ...
        if (tutrlbttl.equals("Vicious slice")) {
          ...
          System.out
              .println("You blocked. The damage that incoming enemy attacks will do to you will be reduced by 1/4.");
          for (int counter = 0; olbaphealth > 0 && yourhealth > 0 && counter < 2; ++counter) {
            olbapattckdmgevt = rng3.nextInt(18) + 5;
            olbapdcreasedmge = olbapattckdmgevt / 4;
            Thread.sleep(2000);
            ...
            System.out.println("Your turn:");
            System.out
                .println("Primary attack: Vicious slice[15-20 damage dealt]   Secondary attack: Block[On cooldown]");
            tutrlbttl = tutrlbttlObj.nextLine();
            if (tutrlbttl.equals("Vicious slice")) {
              yourdmgevelotth = rng2.nextInt(5) + 15;
              Thread.sleep(2000);
